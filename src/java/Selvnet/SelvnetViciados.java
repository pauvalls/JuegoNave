 ...
 * @author pauva
 */
public class SelvnetViciados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SelvnetViciados</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SelvnetViciados at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
     ...
     //   processRequest(request, response);
      ...
      RequestDispatcher a = request.getRequestDispatcher("MasViciados.jsp");
